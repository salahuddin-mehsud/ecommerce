...
export const adminAPI = {
  ...
  // Vouchers (UPDATED: all under /admin)
  getVouchers: async () => {
  ...
  getVoucherByCode: async (code) => {
    const response = await fetch(`${API_BASE_URL}/admin/vouchers/${code}`, {
      headers: getAuthHeaders()
    });
    return response.json();
  },
  ...
  redeemVoucher: async (code) => {
    const response = await fetch(`${API_BASE_URL}/admin/vouchers/${code}/redeem`, {
      method: 'PATCH',
      headers: getAuthHeaders()
    });
    return response.json();
  ...
  redeemVoucherBySpecialCode: async (specialCode) => {
    const response = await fetch(`${API_BASE_URL}/admin/vouchers/redeem/${specialCode}`, {
      method: 'PATCH',
      headers: getAuthHeaders()
    });
    return response.json();
