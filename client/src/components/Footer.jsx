    ...
    <footer className="bg-white dark:bg-black text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 pb-6">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Center nav (small uppercase links) */}
          <nav className="mt-6">
            <ul className="flex flex-wrap items-center justify-center gap-6 text-xs tracking-widest uppercase text-gray-600 dark:text-gray-400">
              <li>
                <a href="#home" className="hover:text-amber-500 dark:hover:text-amber-400 transition">
                  Home
                </a>
              </li>
              <li>
                <a href="#perfumes" className="hover:text-amber-500 dark:hover:text-amber-400 transition">
                  Collections
                </a>
              </li>
              <li>
                <a href="#story" className="hover:text-amber-500 dark:hover:text-amber-400 transition">
                  Our Story
                </a>
              </li>
              <li>
                <a href="#notify" className="hover:text-amber-500 dark:hover:text-amber-400 transition">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div className="mt-6 flex items-center gap-4">
            <a
              href="#"
              aria-label="Twitter"
              className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:bg-amber-500 hover:text-white dark:hover:bg-amber-500 hover:border-amber-500 transition"
            >
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-8 pt-6">
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">&copy; 2025 Daily. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
